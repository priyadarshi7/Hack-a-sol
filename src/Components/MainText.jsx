        ...
        <div className="container">
            <div className="text-content">
                ...
                <div className="buttons">
                    ...
                    <div data-aos="zoom-in" data-aos-duration="500" className="button2" onClick={() => window.open('https://discord.gg/gejd3wHT', '_main')}><div className="img-discord"></div><div>JOIN OUR DISCORD</div></div></div><div>
                </div>
            </div>
        </div>
          )
